...
class BacktestConfig:
    ...
    def strategy_settings(self) -> dict[str, Any]:
        settings: dict[str, Any] = {
            ...
            "SCALPER_THRESHOLD": env_int("SCALPER_THRESHOLD", 40),
            "SCALPER_TP_MIN_PIPS": env_float("SCALPER_TP_MIN_PIPS", 8.0),
            "SCALPER_TP_MAX_PIPS": env_float("SCALPER_TP_MAX_PIPS", 30.0),
            "SCALPER_SL_MIN_PIPS": env_float("SCALPER_SL_MIN_PIPS", 5.0),
            "SCALPER_SL_MAX_PIPS": env_float("SCALPER_SL_MAX_PIPS", 20.0),
            "SCALPER_TP_ATR_MULT": env_float("SCALPER_TP_ATR_MULT", 2.0),
            "SCALPER_SL_ATR_MULT": env_float("SCALPER_SL_ATR_MULT", 1.3),
            "SCALPER_TRAIL_PIPS": env_float("SCALPER_TRAIL_PIPS", 5.0),
            "TREND_MAX_SPREAD_PIPS": env_float("TREND_MAX_SPREAD_PIPS", 2.0),
            "TREND_THRESHOLD": env_int("TREND_THRESHOLD", 45),
            "TREND_TP_ATR_MULT": env_float("TREND_TP_ATR_MULT", 3.5),
            "TREND_SL_ATR_MULT": env_float("TREND_SL_ATR_MULT", 1.5),
            ...
            "BREAKOUT_THRESHOLD": env_int("BREAKOUT_THRESHOLD", 55),
            "BREAKOUT_TP_ATR_MULT": env_float("BREAKOUT_TP_ATR_MULT", 3.0),
            "BREAKOUT_SL_ATR_MULT": env_float("BREAKOUT_SL_ATR_MULT", 1.0),
